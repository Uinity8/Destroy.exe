...
namespace UnityUtils {
    public class VectorMath {
        ...
        /// <summary>
        /// 주어진 점을 시작 위치와 방향 벡터로 정의된 선 위로 투영합니다.
        /// </summary>
        /// <param name="lineStartPosition">선의 시작 위치입니다.</param>
        /// <param name="lineDirection">선의 방향 벡터로, 정규화되어 있어야 합니다.</param>
        /// <param name="point">선 위로 투영할 점입니다.</param>
        /// <returns>원래 점과 가장 가까운, 선 위에 투영된 점을 반환합니다.</returns>
